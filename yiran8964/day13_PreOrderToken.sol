...
contract PreOrderToken is MyToken {
    ...
    constructor(uint _initialSupply, uint256 _tokenPrice, uint256 _saleDurationInSeconds,
    uint256 _minPurchase, uint256 _maxPurchase, address _projectOwner) MyToken(_initialSupply) {
    ...
    function buyTokens() public payable {
        ...
        require(balanceOf(address(this)) >= tokenAmount, "Not enough left for sale");
    ...
    function transfer(address _to, uint256 _value) public override returns(bool) {
        if(!finalized && msg.sender != address(this) && initialTransferDone) {
            require(false, "Tokens are locked until sale is fialized");
        }
