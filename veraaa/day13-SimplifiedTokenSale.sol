...
contract SimplifiedTokenSale is SimpleERC20{
    ...
    constructor(uint256 _initialSupply,uint256 _tokenPrice,uint256 _saleDurationInSeconds,
    uint256 _minPurchase,uint256 _maxPurchase,address _projectOwner)SimpleERC20(_initialSupply){
    ...
    function isSaleActive() public view returns(bool){
        return (!finalized&&saleStartTime<=block.timestamp&&block.timestamp<=saleEndTime);
    }
